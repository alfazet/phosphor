...
bool box_compare0(Triangle &a, Triangle &b) {
    return box_compare(a, b, 0);
}

bool box_compare1(Triangle &a, Triangle &b) {
    return box_compare(a, b, 1);
}

bool box_compare2(Triangle &a, Triangle &b) {
...
void Triangles::split() {
    ...
    u32 axis = random()%3;
    auto comparator = (axis == 0) ? box_compare0
                        : (axis == 1) ? box_compare1
                                      : box_compare2;
...
//         uv = compute_bary(rec.bary, closest_t->uv0, closest_t->uv1, closest_t->uv2);
//     }
//
//     return hit_anything;
// }
